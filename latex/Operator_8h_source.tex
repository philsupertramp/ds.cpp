...
\DoxyCodeLine{00064\ \ \ std::function<\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{double}}(\textcolor{keywordtype}{double},\ \textcolor{keywordtype}{double})>\ \mbox{\hyperlink{classOperator_aa1053c93ac197de3d97d527ce54c6992}{op}};}
...
\DoxyCodeLine{00073\ \ \ \mbox{\hyperlink{classOperator_ad483de0fdafcc9ff8b060b07a0bc41ba}{Operator}}(\textcolor{keyword}{const}\ std::string\&\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{name}},\ std::function<\textcolor{keywordtype}{double}(\textcolor{keywordtype}{double},\ \textcolor{keywordtype}{double})>\ fun,\ \mbox{\hyperlink{Operator_8h_a46dd797d9c42218918ba2a83eb5b8db7}{OperatorPriority}}\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{operatorPriority}})}
\DoxyCodeLine{00074\ \ \ \ \ :\ \mbox{\hyperlink{classMathNode}{MathNode}}(\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{name}})}
\DoxyCodeLine{00075\ \ \ \ \ ,\ \mbox{\hyperlink{classOperator_aa1053c93ac197de3d97d527ce54c6992}{op}}(\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{std}}::\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{move}}(fun))}
\DoxyCodeLine{00076\ \ \ \ \ ,\ \mbox{\hyperlink{classOperator_aac3650047650adcb082c21b2a5bdfb1c}{priority}}(\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{operatorPriority}})\ \{}
...
\DoxyCodeLine{00078\ \ \ \}}
\DoxyCodeLine{00079\ }
\DoxyCodeLine{00084\ \ \ \mbox{\hyperlink{classOperator_ad091ebe59393f33035c648995c331799}{Operator}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classOperator}{Operator}}\&\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{other}})}
\DoxyCodeLine{00085\ \ \ \ \ :\ \mbox{\hyperlink{classMathNode}{MathNode}}(\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{other}})\ \{}
\DoxyCodeLine{00086\ \ \ \ \ \mbox{\hyperlink{classOperator_aa1053c93ac197de3d97d527ce54c6992}{op}}\ \ \ \ \ \ \ =\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{other}}.op;}
\DoxyCodeLine{00087\ \ \ \ \ \mbox{\hyperlink{classOperator_aac3650047650adcb082c21b2a5bdfb1c}{priority}}\ =\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{other}}.priority;}
\DoxyCodeLine{00088\ \ \ \}}
\DoxyCodeLine{00089\ }
\DoxyCodeLine{00094\ \ \ [[\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{nodiscard}}]]\ \textcolor{keywordtype}{double}\ \mbox{\hyperlink{classOperator_ab60d42c50454ab1e8b21aabc03bd04e3}{Evaluate}}()\textcolor{keyword}{\ const\ override\ }\{}
...
\DoxyCodeLine{00096\ \ \ \ \ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{assert}}(\mbox{\hyperlink{classMathNode_a7246ecf47bdb68471202f2c725cb41e4}{left}}\ !=\ \textcolor{keyword}{nullptr}\ \&\&\ \mbox{\hyperlink{classMathNode_af81f7d62cd9008544aa999c6a1c55934}{right}}\ !=\ \textcolor{keyword}{nullptr});}
...
\DoxyCodeLine{00125\ \ \ \mbox{\hyperlink{classFunction_aed501e2ece820e5e66a513486958dcc6}{Function}}(\textcolor{keyword}{const}\ std::string\&\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{val}},\ \textcolor{keyword}{const}\ std::function<\textcolor{keywordtype}{double}(\textcolor{keywordtype}{double})>\&\ fun)}
\DoxyCodeLine{00126\ \ \ \ \ :\ \mbox{\hyperlink{classOperator}{Operator}}(}
\DoxyCodeLine{00127\ \ \ \ \ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{val}},\ [fun](\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{double}}\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{a}},\ [[\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{maybe\_unused}}]]\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{double}}\ b)\ \{\ \textcolor{keywordflow}{return}\ fun(\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{a}});\ \},\ \mbox{\hyperlink{Operator_8h_a46dd797d9c42218918ba2a83eb5b8db7a48873ec61a22f8057aeeb35a848e52da}{OperatorPriority::OPClassFunction}})\ \{}
...
\DoxyCodeLine{00130\ \ \ \}}
\DoxyCodeLine{00131\ }
\DoxyCodeLine{00139\ \ \ \mbox{\hyperlink{classFunction_abb23d3b78d3d3e49f8ec7fd8279af6ca}{Function}}(\textcolor{keyword}{const}\ std::string\&\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{val}},\ \textcolor{keyword}{const}\ std::function<\textcolor{keywordtype}{double}(\textcolor{keywordtype}{double},\ \textcolor{keywordtype}{double})>\&\ fun)}
\DoxyCodeLine{00140\ \ \ \ \ :\ \mbox{\hyperlink{classOperator}{Operator}}(\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{val}},\ fun,\ \mbox{\hyperlink{Operator_8h_a46dd797d9c42218918ba2a83eb5b8db7}{OperatorPriority}}::\mbox{\hyperlink{Operator_8h_a46dd797d9c42218918ba2a83eb5b8db7a48873ec61a22f8057aeeb35a848e52da}{OPClassFunction}})\ \{}
...
\DoxyCodeLine{00144\ \ \ \}}
\DoxyCodeLine{00145\ }
\DoxyCodeLine{00146\ \ \ [[\mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{nodiscard}}]]\ \textcolor{keywordtype}{double}\ \mbox{\hyperlink{classFunction_a519eb048f3d3431d14fee138fcae67a6}{Evaluate}}()\textcolor{keyword}{\ const\ override\ }\{}
...
\DoxyCodeLine{00153\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{matrix__utils_8h_ace948cba52caa75f48454f881bc51a68}{NAN}};}
\DoxyCodeLine{00154\ \ \ \}}
\DoxyCodeLine{00155\ }
